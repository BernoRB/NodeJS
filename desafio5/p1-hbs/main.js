...
app.set("views", "./views");
app.set('view options', { layout: './layouts/index.hbs' }) // Nota interna: esto te jodia que no tomara el bootstrap en todas, no estabas dandole el layout para que consuma
